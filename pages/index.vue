<template>
  <b-container>
    ...
    <div style="background-image: url('/images/card-gradient.png')">
      <div style="border-radius: 42px">
            ...
            <b-row align-v="center" align-h="center" class="py-4 w-100">
              <b-col class="ml-md-auto" cols="12" md="6" sm="12">
                ...
                <p>
                  ...
                  location. From fully customizable performance stages, to
                  fashion airdrops, to brand sponsored immersive activations, to
                  full on music festivals with custom effects the MTRXVERSE is
                  the ultimate home for the next generation of artists to
                  directly connect with their fans around the globe in a whole
                  new way.  You no longer have to BE THERE to BE THERE. Enter
                  the MTRXVerse
                </p>
                <b-button
                  pill
        ...
        <div class="pb-5">
          ...
          >
            <b-carousel-slide img-src="/images/metaweek.png">
            </b-carousel-slide>
        ...
        <div>
          <h1
            ...
            style="font-weight: 700; font-size: 48px"
          >
            NEWS
          </h1>
          <b-card-group deck>
